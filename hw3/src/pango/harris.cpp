...
int main(int argc, char** argv)
  ...
  vector<pangolin::ImageView> iv(4);
  ...
  pangolin::Var<std::function<void(void)>>("ui.SaveScreenshot", [&](void){ save_png(download_framebuffer(),"output/screenshot"); });
  auto run_pipeline=[&]()
    {
    ...
    iv[3].SetImage(toPangolin(feat_norm(nms)));
    };
